...
export const CartProvider = ({ children }) => {
    ...
    return(
        <CartContext.Provider value={{ cart, setCart, onDecreaseItem, onAddToCart, onRemoveCartItem, total, products, categories, setCategories, setProducts, getItemQuantity}}>
            {children}
